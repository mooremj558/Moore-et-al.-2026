...
path = getenv('HMM_PATH')
input = getenv('HMM_input')
output = getenv('HMM_output')

addpath(genpath(strcat(path,'/required_modules/HMMall/'))); 
addpath(genpath(strcat(path,'/required_modules/pmtk3-2april2011/'))); 
addpath(genpath(strcat(path,'/required_modules/order')));
