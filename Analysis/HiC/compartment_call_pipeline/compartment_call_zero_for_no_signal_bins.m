...
ids1 =1;
ABcompartment = [];
gene = load('/scratch/yliang/pipelines/Bing_pipeline_2015/3_hg38_coding_gene_10kb.density');%this file contains the tss number in each 10kb bin on each chromosome
contributions = zeros(50,100);
split = load('/scratch/yliang/pipelines/Bing_pipeline_2015/chrom_split.txt');
for i = 1:chrom
