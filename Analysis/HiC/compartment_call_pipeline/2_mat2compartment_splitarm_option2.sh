...
matlab -nodisplay -nosplash -nodesktop < $pipe_path/compartment_call_nan_for_no_signal_bins.splitarm_option2.m > $output_path/${basename}.$bin_size_n.bing2015.compartment_call.log 2> $output_path/${basename}.$bin_size_n.bing2015.compartment_call.err
